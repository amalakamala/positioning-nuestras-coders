...
linea.style.width = "70px";
linea.style.height = "5px";
linea.style.background = "#000601";
linea.style.position = "absolute"; 
linea.style.top = "45px";
linea.style.left = "68px";

var uno = document.getElementsByClassName("alumna-1")[0];
var dos = document.getElementsByClassName("alumna-2")[0];
var tres = document.getElementsByClassName("alumna-3")[0];
var cuatro = document.getElementsByClassName("alumna-4")[0];
